...
1.1 LocalSchemeHandler

A LocalSchemeHandler is a Cef SchemeHandler class that associates a scheme eg: 'custom://'
in an URL like 'custom://web/index.html' with a local address like: 'C:\TEMP\web\index.html'.
